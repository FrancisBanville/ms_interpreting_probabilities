...
\(< A_0\) within a bigger area \(A_0\) and disjoint from each other,
such as \(N_1\) and \(N_2\) form \(N_0\) (think of two contiguous cells
that together delineate \(N_0\)). All other things being equal, we
should expect the probability that \(i\) and \(j\) interacts in \(A_0\)
to be
