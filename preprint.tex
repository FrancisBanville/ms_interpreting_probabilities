...
and time \(x\), \(y\), \(t\). Surely, the probability that the
...
of biotic interactions. Here, we will use the variable \(\Omega\) as a
substitute for the biological and ecological context in which
...
\begin{equation}\protect\hypertarget{eq:local}{}{P_N(i \rightarrow j | x, y, t, \Omega).}\label{eq:local}\end{equation}
...
\begin{equation}\protect\hypertarget{eq:switch}{}{P_N(i \rightarrow j | x, y, t, \Omega) \le
