...
## Box 2: Dissimilarity of host-parasite networks
...
number of links and connectance scale with the number of sampled local networks,
according to different values of $P(L_{i \rightarrow j}|M_{i \rightarrow j})$.
