...
stuff - why we even have probabilistic networks to start with (or
something like that).
...
\hypertarget{overview-of-probabilities-and-metawebs}{%
\section{Overview of Probabilities and
Metawebs}\label{overview-of-probabilities-and-metawebs}}

How are we defining what the probability of an interaction is (there are
many ways to slice this cake). What does a probability in the context of
a metaweb mean? Can we turn this into a local network realisation that
is also probabilistic and intuitive?

\hypertarget{non-ecological-networks}{%
\section{Non-ecological Networks}\label{non-ecological-networks}}

What can we learn from other systems/fields \emph{e.g.} social networks,
